...
X_MAX = 6 # (NOTE! if this value is modified one also needs to update it in nav_covering.py)
X_MIN = -0.2 # (NOTE! if this value is modified one also needs to update it in nav_covering.py)
Y_MAX = 6 # (NOTE! if this value is modified one also needs to update it in nav_covering.py)
